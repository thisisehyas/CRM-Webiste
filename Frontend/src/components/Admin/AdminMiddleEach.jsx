...
const MiddleEach = (props) => {
  ...
  const handleAdditionalPicModalSave = () => {
    ...
    const apiUrl = `http://127.0.0.1:8080/core/machine/${id}/`;
    axios
      .patch(
        apiUrl,
        {
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title>تغییر تصویر مشخصات فنی</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ textAlign: "right", direction: "rtl" }}>
          <Form>
            <Form.Group controlId="formNewPicture">
...
//there can be a bug.
// don't let the admin submit the button to save changes when there's no image uploaded in the place of the old image. take care of that
