...
//     const apiUrl = `https://jsonplaceholder.typicode.com/photos?_page=${page}&_limit=4`;
//     // `https://jsonplaceholder.typicode.com/photos?_start=${products.length}&_limit=6`;
...
//     setNewImageUrl(service.imageUrl);
//     setShowModal(true);
//   };
