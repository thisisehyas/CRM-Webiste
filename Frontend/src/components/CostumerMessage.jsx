...
//                   >
//                     {selectedStatuses[message.id] || "تغییر وضعیت"}
//                   </Dropdown.Toggle>
//                   <Dropdown.Menu>
//                     <Dropdown.Item
...
// // why does any message i change the status of, gets deleted?
// // the status of all the messages change togther
// // the status of the messages should be loaded and shown in place of the button when we are showing the list of messages.
